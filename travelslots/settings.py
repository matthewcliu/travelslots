# Django settings for travelslots project.
import constants
...
STATICFILES_DIRS = (
    ...
    constants.BASE_PATH + 'travelslots/static',
)
...
SECRET_KEY = 'u47m38ei+r500sf#ali4=3rlbu6d*&amp;p06y0zy@(c(sh@tfy70x'
...
ROOT_URLCONF = 'travelslots.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'travelslots.wsgi.application'
